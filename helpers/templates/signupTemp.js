          ...
          <tr>
            <td align="left" valign="top" style="padding:30px 20px">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="100%">
                    <span style="font-size: 17px;font-weight: 600;"><strong>Hi ${user.fullName||user.firstName}</strong></span>
                  </td>
                </tr>
                <tr><td height="20"></td></tr>
                <tr>
                  <td width="100%">
                    <span style="font-size: 17px;font-weight: 600;"><strong>Your MYNT Professional Account has been created and here are your credentials</strong></span>
                  </td>
                </tr>
                <tr>
                 <td width="100%">
