      ...
      <tr>
        <td align="left" valign="top" style="padding:30px 20px">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="100%">
                <span style="font-size: 17px;font-weight: 600;"><strong>Hello Admin</strong></span>
              </td>
              <td height="15"></td>
            </tr>
            <tr>
           ...
           <tr>
            <td colspan="4"><span style="font-size: 13px;"><strong>Email :</strong></span> <span style="font-size: 13px; color:#0a94d6;"><strong>${data.user.email}</strong></span></td>
          </tr>
          <tr>
           <td height="15"></td>
         </tr>
         <tr>
          <td colspan="4"><span style="font-size: 13px;"><strong>Mobile Number :</strong></span> <span style="font-size: 13px; color:#0a94d6;"><strong>${data.user.phone}</strong></span></td>
        </tr>
      </table>
    </td>
  </tr>
