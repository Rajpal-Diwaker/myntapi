let invoiceHtml = (data)=>{
          ...
          <tr>
            <td align="left" valign="top" style="padding:30px 20px">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="100%">
                    <span style="font-size: 17px;font-weight: 600;"><strong>Please click over the link to download your invoice. </strong></span>
                  </td>
                  <td height="15"></td>
                </tr>
                <tr>
    ...
    // <body>
    //     <h1>GAYN DAIRY</h1>
    //     <h2>PLEASE CLICK OVER THE LINK TO DOWNLOAD YOUR INVOICE</h2>
    //     <a href="${data}">${data}</a>
    // </body>
    // </html>`
